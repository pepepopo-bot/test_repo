...
public class SynchronizedBloomFilterTest {
    ...
    private SynchronizedBloomFilter<Integer> bloomFilter;

    @BeforeClass
    public void createBloomFilter() {
        bloomFilter = new SynchronizedBloomFilter<Integer>(FUNNEL, CAPACITY, FALSE_POSITIVE_PROBABILITY);
    }
