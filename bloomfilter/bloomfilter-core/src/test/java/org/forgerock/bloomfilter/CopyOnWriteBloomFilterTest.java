...
public class CopyOnWriteBloomFilterTest {
    ...
    private CopyOnWriteBloomFilter<Integer> bloomFilter;

    @BeforeClass
    public void createBloomFilter() {
        bloomFilter = new CopyOnWriteBloomFilter<Integer>(FUNNEL, CAPACITY, FALSE_POSITIVE_PROBABILITY);
    }
