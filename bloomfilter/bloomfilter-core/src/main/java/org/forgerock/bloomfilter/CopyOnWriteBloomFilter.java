...
import org.wrensecurity.guava.common.hash.Funnel;
...
final class CopyOnWriteBloomFilter<T> implements BloomFilter<T> {
    ...
    private final AtomicReference<org.wrensecurity.guava.common.hash.BloomFilter<T>> bloomFilterAtomicReference;
    ...
    CopyOnWriteBloomFilter(final Funnel<? super T> funnel,
        ...
        final org.wrensecurity.guava.common.hash.BloomFilter<T> bf =
                org.wrensecurity.guava.common.hash.BloomFilter.create(funnel, (int) capacity, falsePositiveProbability);
        this.bloomFilterAtomicReference = new AtomicReference<org.wrensecurity.guava.common.hash.BloomFilter<T>>(bf);
    }
    ...
    public void addAll(final Collection<? extends T> elements) {
        ...
        boolean changed;
        org.wrensecurity.guava.common.hash.BloomFilter<T> prev;
        org.wrensecurity.guava.common.hash.BloomFilter<T> next;
